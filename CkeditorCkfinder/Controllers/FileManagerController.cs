...
namespace CkeditorCkfinder.Controllers
{
    public class FileManagerController : Controller
    {
        ...
        private string RootPath = "/public/images/"; // Root directory for all file uploads [string]
        ...
        private string IconDirectory = "/public/fileManager/images/fileicons/"; // Icon directory for filemanager. [string]
